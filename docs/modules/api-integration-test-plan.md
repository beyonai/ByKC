...
| DM1–DM12 | 目录创建、更新、get/update、幂等、重命名/移动保留、空目录/子树删除 | `test_directory_create_and_rename_share_entry_metadata_lifecycle`、`test_directory_metadata_update_operations_are_atomic`、`test_directory_metadata_follows_move_and_is_removed_with_subtree`、`test_empty_directory_metadata_disappears_from_every_entry_interface` | 已写 |
