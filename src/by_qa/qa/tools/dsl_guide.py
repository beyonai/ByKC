...
def _build_dsl_guide_content(max_depth: int, max_leaf_count: int) -> str:
    return (
        ...
        "### Limits\n"
        f"- Maximum boolean nesting depth: {max_depth}\n"
        f"- Maximum leaf conditions: {max_leaf_count}\n\n"
        "### Examples\n\n"
        "1. Simple equality:\n"
...
DSL_GUIDE_CONTENT = _build_dsl_guide_content(3, 12)
...
def get_dsl_guide() -> str:
    ...
    return _build_dsl_guide_content(
        settings.dsl_max_depth,
        settings.dsl_max_leaf_count,
    )
